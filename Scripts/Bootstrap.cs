...
public partial class Bootstrap : Node
{
	...
	public static bool UsingMobileUI { get; private set; }
	...
	async void LoadScene(bool lite)
	{
		...
		if (OS.HasFeature("editor") && !AppConfig.TryGet("core", "disable_mobile", out bool _))
			AppConfig.Set("core", "disable_mobile", true);
